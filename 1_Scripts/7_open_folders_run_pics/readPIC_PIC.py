...
# =======================================================
# this algorithm will:
# 1// open a folder that we have our photos inside
# 2// detect the droplets and print out the
# 3-column matrixes that we want
# 3// to the growth rate for each frame to frame
# =======================================================
from numpy.core._multiarray_umath import ndarray
start_time = time.time()

droplet_counter_all = 0
...
for i in range(len(listOfFiles)):
    ...
    def create_Matrix(im_initial, im_in):
        ...
        Matrix = np.zeros((Radii.shape[0], 3), dtype=int)
